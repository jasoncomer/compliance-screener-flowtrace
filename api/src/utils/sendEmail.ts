...
export const sendOrganizationInviteEmail = (userEmail: string, organizationName: string, inviterName: string, link: string, organizationEmail?: string) => {
  htmlContent = `
<!DOCTYPE html>
<html lang="en-US">
  <head>
    ...
    <meta name="description" content="Organization Invitation Email" />
    <style type="text/css">
      a:hover {
        text-decoration: underline !important;
      }
  ...
  <body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #f2f3f8;" leftmargin="0">
    <table cellspacing="0" border="0" cellpadding="0" width="100%" bgcolor="#f2f3f8"
      ...
      <tr>
        <td>
          <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto; font-size: 110%;" width="100%" border="0"
                ...
                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                    <td style="padding:35px;">
                      ...
                      <p style="color:#455056; font-size:12px;line-height:24px; margin-top:20px;">
...
`;
  ...
  const emailContent = {
    from: organizationEmail || environmentConfig.ADMIN_SEND_GRID_EMAIL,
    to: userEmail,
  ...
  transporter.sendMail(emailContent, function (error, _info) {
    if (error) {
      ...
      console.log(`Successfully sent invitation email to ${userEmail}`);
    }
  });
};

export default { sendEmailVerificationEmail, sendEmail, sendResetPasswordEmail, sendConfirmResetPasswordEmail, sendOrganizationInviteEmail };
