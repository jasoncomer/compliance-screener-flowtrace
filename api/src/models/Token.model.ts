...
export interface ITokenDocument extends Document, IToken {
  ...
  generateToken(payload: { userId: Schema.Types.ObjectId }, secret: string, signOptions: any): Promise<string>;
}
...
// export default mongoose.models.Token || mongoose.connection.useDb('blockscout-db').model('Token', TokenSchema);
